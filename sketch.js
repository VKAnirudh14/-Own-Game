...
function draw() {
 ...
 text("0",750,500);
  ...
  if((particles.x>240 && particle.x<320) || (particles.x>480 && particles.x <560)){
    score = score +300;
  }

  if((particles.x>320 && particles.x<400) || (particles.x>400 && particle.x<480)){
    score = score +400;
  }
}

function mousePressed(){
  particles.push(new Particle(50,50,10));
}
